...
namespace api_vendamode.Migrations
{
    ...
    [Migration("20240603095245_InitAddRoleNamesInUserSpecification")]
    partial class InitAddRoleNamesInUserSpecification
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api_vendace.Entities.EntityImage<System.Guid, api_vendace.Entities.Users.User>", b =>
                {
                    ...
                    b.HasOne("api_vendace.Entities.Users.UserSpecification", null)
                        .WithMany("Images")
